 ...
 * 多态的解释：https://www.liaoxuefeng.com/wiki/1252599548343744/1260455778791232
 */
(() => {
  // 定义一个父类
  class Animal {
 ...
 * 抽象类是不能被实例化的，只能被继承，抽象类可以强迫子类实现其定义的抽象方法
 * 抽象类是为了让子类进行实例化 及 实现内部的抽象方法
 * 
 * 抽象类解释：https://www.liaoxuefeng.com/wiki/1252599548343744/1260456371027744
